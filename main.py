...
INTRO_BUYER = '<i>Игра началась! Вы - потенциальный <b>покупатель</b> подписки на Яндекс.Музыку. ' \
              'nВаша задача - выяснить, нужна ли вам подписка, и, если нужна, купить подешевле.' \
              '\nУспешного торга!</i>'


INTRO_SELLER = '<i>Игра началась! Вы - <b>продавец</b> подписки на Яндекс.Музыку. ' \
