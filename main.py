...
о других игроках, переходящих в состояние active.
"""
import argparse
import mongomock
import os
...
INTRO_BUYER = 'Игра началась! Вы - потенциальный покупатель подписки на Яндекс.Музыку. ' \
                    '\nВаша задача - выяснить, нужна ли вам подписка, и, если нужна, купить подешевле.'


INTRO_SELLER = 'Игра началась! Вы - продавец подписки на Яндекс.Музыку. ' \
